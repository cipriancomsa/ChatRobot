...
// of selecting the 'longest keyword' that match's the current user input. So the 'longest keywords'
// by these algorithm are ranked as the best keywords for the given input.
//
